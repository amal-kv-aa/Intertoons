...
class DetailsModel {
    ...
    factory DetailsModel.fromJson(Map<String, dynamic> json) => DetailsModel(
        ...
        data: json["Data"] = Detail.fromJson(json["Data"]),
    );
...
class Detail {
    ...
    List<ProdImage>? prodImages;

    factory Detail.fromJson(Map<String, dynamic> json) => Detail(
        prodDetails: json["ProdDetails"] == null ? null : ProdDetails.fromJson(json["ProdDetails"]),
        prodImages: json["ProdImages"] == null ? null : List<ProdImage>.from(json["ProdImages"].map((x) => ProdImage.fromJson(x))),
    );
...
class ProdDetails {
  ...
  double? isReviewAvgrating;
    ...
    factory ProdDetails.fromJson(Map<String, dynamic> json) => ProdDetails(
